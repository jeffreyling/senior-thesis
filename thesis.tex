...
\paragraph{Positional embeddings} \todo{finish}
...
\begin{figure}
\caption{Training curves for models.} % train, test curves for model 0-3
...
\todo{something about train vs val}
...
\todo{analysis} Appendix ??? shows more predicted summaries.
