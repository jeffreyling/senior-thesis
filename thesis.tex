...
\cite{mikolov2013word2vec} show that training deep networks can also work on language.  % and maybe more?

% diagram of vectors, perhaps an example of the analogy (king man woman queen)
...
Second, removing assumptions about the input to a system allows us to build more general models -- this has already proven to be useful in machine translation, where one system can be applied to many different settings. If we used a system of parsers  %% not sure this argument works. seq2seq can't be trained on low resource languages.
...
Originated with \cite{luhn1958automatic} % expand
